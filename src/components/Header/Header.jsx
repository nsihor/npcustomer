...
const Header = ({openLoginModal, companyName}) => {
    ...
    return (
        <header className={clsx(css.header, 'py-3 fixed-top')}>
            <div className='container'>
                <nav className='navbar navbar-expand-md p-0'>
                    <div className={clsx(css.navContainer, 'container-fluid justify-content-start p-0')}>
                        {isMobile &&
                            <button
                                onClick={toggleMenu}
                                className={clsx(css.burgerIco, 'navbar-toggler border-0 p-0')}
                                type='button'
                        ...
                        <div className='text-md-start mb-md-0'>
                            <Link to='/'>
                                <svg className={clsx(css.logo, 'p-1')}>
